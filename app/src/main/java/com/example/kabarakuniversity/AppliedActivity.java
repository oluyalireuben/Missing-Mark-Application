...
public class AppliedActivity extends AppCompatActivity {
    ActivityAppliedBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAppliedBinding.inflate(getLayoutInflater());
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AppliedActivity.this, StudentDashboardActivity.class));
            }
        });

        onUnitClicked = position -> startActivity(new Intent(AppliedActivity.this, AppliedDetails.class)
