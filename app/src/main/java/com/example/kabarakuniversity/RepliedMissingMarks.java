...
import com.example.kabarakuniversity.databinding.ActivityRepliedDetailsBinding;
import com.example.kabarakuniversity.databinding.ActivityRepliedMissingMarksBinding;
...
public class RepliedMissingMarks extends AppCompatActivity {
    ActivityRepliedMissingMarksBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRepliedMissingMarksBinding.inflate(getLayoutInflater());
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(RepliedMissingMarks.this, LecturerDashboardActivity.class));
            }
        });

        onUnitClicked = position -> startActivity(new Intent(RepliedMissingMarks.this, RepliedDetails.class)
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new RepliedUnitsAdapter(grades, RepliedMissingMarks.this, onUnitClicked));
