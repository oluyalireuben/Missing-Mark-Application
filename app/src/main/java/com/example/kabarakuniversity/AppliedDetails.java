...
public class AppliedDetails extends AppCompatActivity {
    TextView regno, student, name, code, unitstage, lecturer, semester, year, exam, comment;
    ArrayList<MissingMarksApplication> arrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_applied_details);
        ...
        llback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AppliedDetails.this, AppliedActivity.class));
            }
        });
